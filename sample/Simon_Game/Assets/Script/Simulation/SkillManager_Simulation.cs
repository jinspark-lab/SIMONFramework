...
public class SkillManager_Simulation : MonoBehaviour {

	public static SkillManager_Simulation skillManagerVal;
	...
	private void clearSnowball(GameObject obj, string kindOfSkill)
	{
		if (obj.tag.ToString ().Equals ("Enemy")) 
			obj.GetComponent<Monster_Controller_B_Simulation>().SnowballSprite = Snowball_Blue;
		else if(obj.tag.ToString ().Equals ("Home"))
			obj.GetComponent<Monster_Controller_Simulation>().SnowballSprite = Snowball_Normal;
	}

	private void setSnowball(GameObject obj, string kindOfSkill)
	{
		if (obj.tag.ToString ().Equals ("Enemy")) 
			obj.GetComponent<Monster_Controller_B_Simulation>().SnowballSprite = Snowball_Skill;
		else if(obj.tag.ToString ().Equals ("Home"))
			obj.GetComponent<Monster_Controller_Simulation>().SnowballSprite = Snowball_Skill;
	}
