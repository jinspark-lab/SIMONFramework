...
namespace SIMONFramework
{
    ...
    static class SIMONConstants
    {
        ...
        public const int MAX_SIMONOBJ_NUM = 10000;
        ...
        #region SIMONException 메시지
        
        public const string EXP_KEY_NOT_FOUND_MSG = "[SIMON Framework] : There is no element the name of which equals given parameter. - ";
        public const string EXP_DUPLICATED_KEY_MSG = "[SIMON Framework] : Duplicated key value exception. - ";
        public const string EXP_ACCESS_VIOLATION_MSG = "[SIMON Framework] : Access Violation.";
        public const string EXP_IDX_OUT_OF_RANGE_MSG = "[SIMON Framework] : Input index number is out of dictionary's range";
        public const string EXP_ARG_NULL_MSG = "[SIMON Framework] : Invalid Argument. - ";
        public const string EXP_NOT_IMPLEMENT_MSG = "[SIMON Framework] : SIMON does not implement the function.";
        public const string EXP_VALUE_OVERFLOW = "[SIMON Framework] : Fitness Value overflow exception occurs.";
        public const string EXP_VALUE_UNDERFLOW = "[SIMON Framework] : Fitness Value underflow exception occurs.";
        public const string EXP_LEARNING_FAULT = "[SIMON Framework] : Learning process failure.";
        public const string EXP_INVALID_ALGORITHM_CLS = "[SIMON Framework] : Invalid algorithm implementation.";
