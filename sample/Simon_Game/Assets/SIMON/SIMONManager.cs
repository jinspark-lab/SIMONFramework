...
namespace SIMONFramework
{
    ...
    public sealed class SIMONManager                                                                //SIMONManager는 다른 클래스에서 상속받는 것이 불가능하도록 구현...?!
    {
        ...
        /// </summary>
        private Dictionary<string, SIMONObject> SimonDefinitionObjects { get; set; }

        /// <summary>
        /// SimonFramework에서 사용되는 함수들을 Dictionary형태로 조회해서 반환하는 ADT.
        /// </summary>
        public Dictionary<string, SIMONFunction> SimonFunctions { get; set; }
        ...
        /// </summary>
        /// <param name="objectID">Object Factory에서 반환할 형태의 SIMONObject의 ID입니다.</param>
        /// <returns>Factory를 통해 반환되는 SIMONObject Copy.</returns>
        ...
        /// </summary>
        /// <param name="methodName">추가시킬 함수 이름입니다.</param>
        /// <param name="classType">함수가 위치한 클래스입니다.</param>
